...
public class EnemigoEspada extends Enemigo {
	...
	public void movimiento() {
		...
		case 1: // Arriba
			...
			posicionHechizo = new Vector2D(super.getCuerpo().getTransformar().getPosicion().getX() + 20,
					super.getCuerpo().getTransformar().getPosicion().getY() - 320);
		...
		case 2: // Abajo
			...
			posicionHechizo = new Vector2D(super.getCuerpo().getTransformar().getPosicion().getX() + 20,
					super.getCuerpo().getTransformar().getPosicion().getY() + 70);
			super.getAtaque().getTransformar().rotarloA(0);
			super.getAtaque().getTransformar().setPosicion(posicionHechizo);
			break;
		case 3: // Izquierda
			...
			posicionHechizo = new Vector2D(super.getCuerpo().getTransformar().getPosicion().getX() - 170,
					super.getCuerpo().getTransformar().getPosicion().getY() - 125);
		...
		case 4: // Derecha
			...
			posicionHechizo = new Vector2D(super.getCuerpo().getTransformar().getPosicion().getX() + 220,
					super.getCuerpo().getTransformar().getPosicion().getY() - 125);
			super.getAtaque().getTransformar().rotarloA(90);
			super.getAtaque().getTransformar().setPosicion(posicionHechizo);
			break;
